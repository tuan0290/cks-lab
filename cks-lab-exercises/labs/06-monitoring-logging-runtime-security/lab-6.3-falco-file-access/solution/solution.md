# Solution: Lab 6.3 - Falco Custom Rules - Sensitive File Access Monitoring
...
kubectl exec -n lab-6-3 $TEST_POD -- cat /etc/passwd

# Trigger the rule by reading /etc/sudoers
kubectl exec -n lab-6-3 $TEST_POD -- cat /etc/sudoers 2>/dev/null || true
```
