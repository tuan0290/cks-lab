# Solution: Lab 6.9 - Runtime Immutability - Immutable Containers and Read-Only Filesystems
...
kubectl exec -n lab-6-9 immutable-pod -- touch /test-file
# Output: touch: /test-file: Read-only file system

# This should SUCCEED
kubectl exec -n lab-6-9 immutable-pod -- touch /tmp/test-file
# Output: (no error)

# This should SUCCEED
kubectl exec -n lab-6-9 immutable-pod -- touch /var/cache/nginx/test
# Output: (no error)
```
