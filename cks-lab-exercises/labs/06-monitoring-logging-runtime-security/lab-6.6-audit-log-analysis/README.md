# Lab 6.6: Audit Log Query and Analysis
...
5. **Task**: Create a ConfigMap named `audit-analysis-results` in namespace `lab-6-6` with:
...
6. **Task**: Create a ConfigMap named `audit-query-commands` in namespace `lab-6-6` documenting 4 useful `jq` queries for audit log analysis.
