# Solution: Lab 6.8 - Kubernetes Incident Response Procedures
...
kubectl logs suspicious-pod -n lab-6-8 --tail=50
...
kubectl get rolebindings -n lab-6-8 -o yaml | grep -A10 "compromised"
```
...
kubectl exec -n lab-6-8 suspicious-pod -- ls -la /tmp/ >> /tmp/incident-evidence.txt 2>/dev/null || true
...
# kubectl delete rolebinding compromised-binding -n lab-6-8
# kubectl delete role overprivileged-role -n lab-6-8
